...
//       <footer className='font-inter bg-footer py-8 px-14  text-white'>
...
//           <h3 className='font-bold tracking-wider mb-1 leading-6 text-2xl flex-nowrap
// '>Quick Links</h3>
//           <ul>
...
function Footer() {
  return (
    <footer className='font-inter bg-footer py-6 px-2 text-white'>
